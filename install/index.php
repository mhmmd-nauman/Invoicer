...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
      ...
      $redir = str_replace('install/','',$redir); 
		...
		$message = $core->show_message('error','Not all fields have been filled in correctly. <b>All fields below are required to install Innvoice.</b>');
	}
}
...
<html lang="en">
	<head>
		<meta charset="utf-8">
	    <title>Innvoice Installation</title>
		...
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-4">
				...
				<div class="text-center" style="margin-top: 70px; margin-bottom: 10px;">
					<img src="../img/favicon.png" alt="Innvoice" style="width: 75px; margin-bottom: 30px">
				</div>
				...
				<form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="installForm">
					...
					<div class="form-group">
				  	...
				  	<button type="submit" class="btn btn-primary btn-embossed btn-block"><span class="fui-check"></span> Install <b>Innvoice</b></button>
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<div class="text-center" style="margin-top: 70px; margin-bottom: 10px;">
					<img src="../img/logo.png" alt="Innvoice" style="width: 100px">
				</div>
	...
	$(function(){
		...
		$('form#installForm').on('submit', function () {
