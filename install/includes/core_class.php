...
class Core {
	...
	function validate_post($data)
	{
		...
		/* Validating the hostname, the database name, the username and the base_url. The password is optional. */
		return !empty($data['hostname']) && !empty($data['username']) && !empty($data['database']) && !empty($data['base_url']);
	}
